...
auto l_springRBConstraint =
    [](const SpringSquaredRBEnergy *energy, const int i, const RigidBodyGroup &rbGroup, auto &dC) {
...
void SpringSquaredRBEnergy::addStencil(std::array<int, s_stencilSize> stencil,
...
void SpringSquaredRBEnergy::dConstraints(const int i, const RigidBodyGroup &rbGroup, ConstraintsAD1 &dC) const
{
    l_springRBConstraint(this, i, rbGroup, dC);
}

void SpringSquaredRBEnergy::dConstraints(const int i, const RigidBodyGroup &rbGroup, ConstraintsAD2 &dC) const
{
    l_springRBConstraint(this, i, rbGroup, dC);
}
}  // namespace spg