...
auto l_loadConstraint =
    [](const StaticLoadEnergy * /*energy*/, const int /*i*/, const ParticleGroup & /*obj*/, auto & /*dC*/) {
...
auto l_loadEnergy = [](const StaticLoadEnergy *energy, const int i, const ParticleGroup &obj, auto &dE) {
...
void StaticLoadEnergy::dEnergy(const int i, const ParticleGroup &obj, RealAD1 &dC) const
{
    l_loadEnergy(this, i, obj, dC);
}

void StaticLoadEnergy::dEnergy(const int i, const ParticleGroup &obj, RealAD2 &dC) const
{
    l_loadEnergy(this, i, obj, dC);
}

void StaticLoadEnergy::dConstraints(const int i, const ParticleGroup &obj, ConstraintsAD1 &dC) const
{
    l_loadConstraint(this, i, obj, dC);
}

void StaticLoadEnergy::dConstraints(const int i, const ParticleGroup &obj, ConstraintsAD2 &dC) const
{
    l_loadConstraint(this, i, obj, dC);
}
}  // namespace spg