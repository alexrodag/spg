...
auto l_bendingConstraint =
    [](const BaraffWitkinBendingEnergy *energy, const int i, const ParticleGroup &pGroup, auto &dC) {
...
void BaraffWitkinBendingEnergy::preparePrecomputations(const ParticleGroup &pGroup)
{
...
void BaraffWitkinBendingEnergy::dConstraints(int i, const ParticleGroup &pGroup, ConstraintsAD1 &dC) const
{
    l_bendingConstraint(this, i, pGroup, dC);
}
void BaraffWitkinBendingEnergy::dConstraints(int i, const ParticleGroup &pGroup, ConstraintsAD2 &dC) const
{
    l_bendingConstraint(this, i, pGroup, dC);
}
