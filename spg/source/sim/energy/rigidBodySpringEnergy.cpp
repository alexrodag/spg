...
auto l_springRBConstraint = [](const RBSpringEnergy *energy, const int i, const RigidBodyGroup &rbGroup, auto &dC) {
...
void RBSpringEnergy::addStencil(std::array<int, s_stencilSize> stencil,
...
void RBSpringEnergy::dConstraints(const int i, const RigidBodyGroup &rbGroup, ConstraintsAD1 &dC) const
{
    l_springRBConstraint(this, i, rbGroup, dC);
}

void RBSpringEnergy::dConstraints(const int i, const RigidBodyGroup &rbGroup, ConstraintsAD2 &dC) const
{
    l_springRBConstraint(this, i, rbGroup, dC);
}
}  // namespace spg